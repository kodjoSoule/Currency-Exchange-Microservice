...
public class ConverterModel {
    ...
    public ConverterModel() {
    	...
    	devises = new String[]{"Eur", "CFA", "Dollar Americain","Yen", "Livre Sterling", "Dinar Tunisien", "Cedi"};
    }
	...
	public double getTaux(String deviseFrom, String deviseTo) {
		double tauxEchangeFrom = getTauxEchange(deviseFrom);
		double tauxEchangeTo = getTauxEchange(deviseTo);
		return tauxEchangeFrom / tauxEchangeTo;
	}
